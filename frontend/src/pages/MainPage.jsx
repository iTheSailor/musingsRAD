    ...
    <>
        ...
        <Segment style={{ padding: '8em 0em' }} vertical>
            <Grid container stackable verticalAlign='middle'>
                <Grid.Row>
                <Grid.Column width={8}>
            <Header as='h3' style={{ fontSize: '2em' }} content="stuff will be here">
              
            </Header>
            <p style={{ fontSize: '1.33em' }}>
              yay stuff!
            </p>
            <Header as='h3' style={{ fontSize: '2em' }} content="another section of stuff">
              
            </Header>
            <p style={{ fontSize: '1.33em' }}>
                Yes thats right, more stuff..
            </p>
          </Grid.Column>
        ...
        <Segment style={{ padding: '8em 0em' }} vertical>
            <Container text>
                ...
                <p style={{ fontSize: '1.33em' }}>
                    Instead of on content creation and hard work, we have learned how to master the
